...
# Load the log file
log_path = 'Autonomous_robots_Ex2/Tello-Semi-Autonomous-main/Tello-Semi-Autonomous-main/Qualification Stage/challengeA/first/log1.csv'
...
output_video_path = '/live_result/processed_live_video.mp4'
...
# Process each frame in the live video
frame_idx = 0
while cap.isOpened():
    ret, frame = cap.read()
    if not ret:
...
result_df.to_csv(
    'C:/projects/Atumic Robots/Ex2/Autonomous_robots_Ex2/live_result/drone_route_with_aruco_locations.csv',
    index=False)
